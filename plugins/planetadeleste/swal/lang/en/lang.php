...
return [
    'plugin'   => [
        'name'        => 'Sweet Alert',
        'description' => 'This component show Flash alerts using SweetAlert library',
    ],
    'settings' => [
        'name'               => 'Config Name',
        'options'            => 'Options',
        'setting'            => 'Settings',
        'global'             => 'Global',
        'global_comment'     => 'Global styles for Ajax events',
        'theme'              => 'Theme',
        'default_theme'      => 'Default Sweet Alert',
        'no_options'         => 'Use default Sweet Alert settings',
    ],
    'doc'      => [
        ...
        'theme'              => 'Change the theme of Swal - SweetAlert',
    ]
];