...
class __TwigTemplate_e8367eeec57dc053c6fe4f987e24c4a5cf8d353270024001c56d4adcb0823b87 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
       ...
       <div class=\"w-table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["record"]) {
            ...
            echo "\" target=\"_blank\"> Contratar </a>
                                </div>
                            </div>
                    ...
                    {# Use spaceless tag to remove spaces inside the A tag. #}
                        ...
                        <div class=\"w-card color-teal s12 m3 l3\">
                            <div class=\"card-header\">
                                ...
                                <div class=\"container-button\">
                                    <a class=\"w-button\" href=\"{{ 'pagos/registrar'|page({ subscriptions_id: record.id })}}\" target=\"_blank\"> Contratar </a>
                                </div>
                            </div>
                            <div class=\"card-content\">
                                {{ record.descripcion }}
